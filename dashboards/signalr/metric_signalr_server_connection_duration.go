...
func NewServerConnectionDuration() ServerConnectionDuration {
     ...
     return ServerConnectionDuration{ 
...
func (m ServerConnectionDuration) With(extras ...interface {SignalrConnectionStatus() AttrConnectionStatus;SignalrTransport() AttrTransport;}) prometheus.Observer { 
...
func (a ServerConnectionDurationExtra) SignalrConnectionStatus() AttrConnectionStatus {return a.AttrConnectionStatus}
