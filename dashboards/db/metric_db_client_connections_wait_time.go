...
func NewClientConnectionsWaitTime() ClientConnectionsWaitTime {
     ...
     return ClientConnectionsWaitTime{ 
        HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
            Name: "db_client_connections_wait_time",
            Help: "Deprecated, use `db.client.connection.wait_time` instead. Note: the unit also changed from `ms` to `s`.",
     }, labels)}
}

func (m ClientConnectionsWaitTime) With(clientConnectionsPoolName AttrClientConnectionsPoolName,extras ...interface {}) prometheus.Observer {
    return m.HistogramVec.WithLabelValues(clientConnectionsPoolName.Value(),)
}

// Deprecated: Use [ClientConnectionsWaitTime.With] instead
func (m ClientConnectionsWaitTime) WithLabelValues(lvs ...string) prometheus.Observer {
    return m.HistogramVec.WithLabelValues(lvs...)
}



type ClientConnectionsWaitTimeExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsWaitTimeExtra",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "client.connections.wait_time",
        "Type": "ClientConnectionsWaitTime",
        "attributes": [
            {
