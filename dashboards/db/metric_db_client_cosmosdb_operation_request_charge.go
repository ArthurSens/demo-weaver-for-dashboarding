...
func NewClientCosmosdbOperationRequestCharge() ClientCosmosdbOperationRequestCharge {
     ...
     return ClientCosmosdbOperationRequestCharge{ 
...
func (m ClientCosmosdbOperationRequestCharge) With(extras ...interface {DbCollectionName() AttrCollectionName;DbCosmosdbConsistencyLevel() AttrCosmosdbConsistencyLevel;DbCosmosdbSubStatusCode() AttrCosmosdbSubStatusCode;DbNamespace() AttrNamespace;DbOperationName() AttrOperationName;DbCosmosdbRegionsContacted() AttrCosmosdbRegionsContacted;}) prometheus.Observer { 
...
func (a ClientCosmosdbOperationRequestCharge) WithCosmosdbConsistencyLevel (attr interface { DbCosmosdbConsistencyLevel() AttrCosmosdbConsistencyLevel } ) ClientCosmosdbOperationRequestCharge {
    a.extra.AttrCosmosdbConsistencyLevel = attr.DbCosmosdbConsistencyLevel()
    return a
}
func (a ClientCosmosdbOperationRequestCharge) WithCosmosdbSubStatusCode (attr interface { DbCosmosdbSubStatusCode() AttrCosmosdbSubStatusCode } ) ClientCosmosdbOperationRequestCharge {
...
func (a ClientCosmosdbOperationRequestCharge) WithCosmosdbRegionsContacted (attr interface { DbCosmosdbRegionsContacted() AttrCosmosdbRegionsContacted } ) ClientCosmosdbOperationRequestCharge {
...
func (a ClientCosmosdbOperationRequestChargeExtra) DbCollectionName() AttrCollectionName {return a.AttrCollectionName}
func (a ClientCosmosdbOperationRequestChargeExtra) DbCosmosdbConsistencyLevel() AttrCosmosdbConsistencyLevel {return a.AttrCosmosdbConsistencyLevel}
func (a ClientCosmosdbOperationRequestChargeExtra) DbCosmosdbSubStatusCode() AttrCosmosdbSubStatusCode {return a.AttrCosmosdbSubStatusCode}
func (a ClientCosmosdbOperationRequestChargeExtra) DbNamespace() AttrNamespace {return a.AttrNamespace}
func (a ClientCosmosdbOperationRequestChargeExtra) DbOperationName() AttrOperationName {return a.AttrOperationName}
func (a ClientCosmosdbOperationRequestChargeExtra) DbCosmosdbRegionsContacted() AttrCosmosdbRegionsContacted {return a.AttrCosmosdbRegionsContacted}
