...
func NewClientConnectionsIdleMin() ClientConnectionsIdleMin {
     ...
     return ClientConnectionsIdleMin{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "db_client_connections_idle_min",
            Help: "Deprecated, use `db.client.connection.idle.min` instead.",
     }, labels)}
}

func (m ClientConnectionsIdleMin) With(clientConnectionsPoolName AttrClientConnectionsPoolName,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(clientConnectionsPoolName.Value(),)
}

// Deprecated: Use [ClientConnectionsIdleMin.With] instead
func (m ClientConnectionsIdleMin) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}



type ClientConnectionsIdleMinExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ClientConnectionsIdleMinExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "client.connections.idle.min",
        "Type": "ClientConnectionsIdleMin",
        "attributes": [
            {
