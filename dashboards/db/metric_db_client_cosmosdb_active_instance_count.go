...
func NewClientCosmosdbActiveInstanceCount() ClientCosmosdbActiveInstanceCount {
     ...
     return ClientCosmosdbActiveInstanceCount{ 
...
func (m ClientCosmosdbActiveInstanceCount) With(extras ...interface {ServerPort() server.AttrPort;ServerAddress() server.AttrAddress;}) prometheus.Gauge { 
...
func (a ClientCosmosdbActiveInstanceCountExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
