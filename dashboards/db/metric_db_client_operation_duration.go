...
func (m ClientOperationDuration) With(systemName AttrSystemName,extras ...interface {DbCollectionName() AttrCollectionName;DbNamespace() AttrNamespace;DbOperationName() AttrOperationName;DbResponseStatusCode() AttrResponseStatusCode;ErrorType() error.AttrType;ServerPort() server.AttrPort;DbQuerySummary() AttrQuerySummary;DbStoredProcedureName() AttrStoredProcedureName;NetworkPeerAddress() network.AttrPeerAddress;NetworkPeerPort() network.AttrPeerPort;ServerAddress() server.AttrAddress;DbQueryText() AttrQueryText;}) prometheus.Observer { 
...
func (a ClientOperationDuration) WithStoredProcedureName (attr interface { DbStoredProcedureName() AttrStoredProcedureName } ) ClientOperationDuration {
    a.extra.AttrStoredProcedureName = attr.DbStoredProcedureName()
    return a
}
func (a ClientOperationDuration) WithNetworkPeerAddress (attr interface { NetworkPeerAddress() network.AttrPeerAddress } ) ClientOperationDuration {
...
func (a ClientOperationDurationExtra) DbCollectionName() AttrCollectionName {return a.AttrCollectionName}
...
func (a ClientOperationDurationExtra) DbResponseStatusCode() AttrResponseStatusCode {return a.AttrResponseStatusCode}
...
func (a ClientOperationDurationExtra) DbStoredProcedureName() AttrStoredProcedureName {return a.AttrStoredProcedureName}
func (a ClientOperationDurationExtra) NetworkPeerAddress() network.AttrPeerAddress {return a.AttrNetworkPeerAddress}
func (a ClientOperationDurationExtra) NetworkPeerPort() network.AttrPeerPort {return a.AttrNetworkPeerPort}
