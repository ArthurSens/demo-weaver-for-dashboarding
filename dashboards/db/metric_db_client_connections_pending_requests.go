...
func NewClientConnectionsPendingRequests() ClientConnectionsPendingRequests {
     ...
     return ClientConnectionsPendingRequests{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "db_client_connections_pending_requests",
            Help: "Deprecated, use `db.client.connection.pending_requests` instead.",
     }, labels)}
}

func (m ClientConnectionsPendingRequests) With(clientConnectionsPoolName AttrClientConnectionsPoolName,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(clientConnectionsPoolName.Value(),)
}

// Deprecated: Use [ClientConnectionsPendingRequests.With] instead
func (m ClientConnectionsPendingRequests) WithLabelValues(lvs ...string) prometheus.Gauge {
...
State {
    ...
    ctx: {
        ...
        "Name": "client.connections.pending_requests",
        "Type": "ClientConnectionsPendingRequests",
        "attributes": [
            {
