...
func NewRateLimitingRequestLeaseDuration() RateLimitingRequestLeaseDuration {
     ...
     return RateLimitingRequestLeaseDuration{ 
...
func (a RateLimitingRequestLeaseDurationExtra) AspnetcoreRateLimitingPolicy() AttrRateLimitingPolicy {return a.AttrRateLimitingPolicy}
...
State {
    ...
    ctx: {
        ...
        "Name": "rate_limiting.request_lease.duration",
        "Type": "RateLimitingRequestLeaseDuration",
        "attributes": [
            {
