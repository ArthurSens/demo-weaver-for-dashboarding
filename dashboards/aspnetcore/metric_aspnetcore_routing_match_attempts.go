...
func (m RoutingMatchAttempts) With(routingMatchStatus AttrRoutingMatchStatus,extras ...interface {AspnetcoreRoutingIsFallback() AttrRoutingIsFallback;HttpRoute() http.AttrRoute;}) prometheus.Counter { 
...
func (a RoutingMatchAttemptsExtra) AspnetcoreRoutingIsFallback() AttrRoutingIsFallback {return a.AttrRoutingIsFallback}
