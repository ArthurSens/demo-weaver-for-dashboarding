...
func (m DiagnosticsExceptions) With(diagnosticsExceptionResult AttrDiagnosticsExceptionResult,kind error.AttrType,extras ...interface {AspnetcoreDiagnosticsHandlerType() AttrDiagnosticsHandlerType;}) prometheus.Counter { 
...
func (a DiagnosticsExceptions) WithDiagnosticsHandlerType (attr interface { AspnetcoreDiagnosticsHandlerType() AttrDiagnosticsHandlerType } ) DiagnosticsExceptions {
...
func (a DiagnosticsExceptionsExtra) AspnetcoreDiagnosticsHandlerType() AttrDiagnosticsHandlerType {return a.AttrDiagnosticsHandlerType}
