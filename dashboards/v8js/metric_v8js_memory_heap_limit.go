...
func (m MemoryHeapLimit) With(heapSpaceName AttrHeapSpaceName,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(heapSpaceName.Value(),)
}

// Deprecated: Use [MemoryHeapLimit.With] instead
func (m MemoryHeapLimit) WithLabelValues(lvs ...string) prometheus.Gauge {
