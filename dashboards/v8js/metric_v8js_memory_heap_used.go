...
func NewMemoryHeapUsed() MemoryHeapUsed {
...
func (m MemoryHeapUsed) With(heapSpaceName AttrHeapSpaceName,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(heapSpaceName.Value(),)
}

// Deprecated: Use [MemoryHeapUsed.With] instead
func (m MemoryHeapUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
