...
func NewSdkProcessorSpanQueueCapacity() SdkProcessorSpanQueueCapacity {
     ...
     return SdkProcessorSpanQueueCapacity{ 
...
func (m SdkProcessorSpanQueueCapacity) With(extras ...interface {OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;}) prometheus.Gauge { 
...
func (a SdkProcessorSpanQueueCapacityExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkProcessorSpanQueueCapacityExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
...
State {
    ...
    ctx: {
        ...
        "Name": "sdk.processor.span.queue.capacity",
