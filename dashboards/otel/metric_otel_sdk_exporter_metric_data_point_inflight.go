...
func NewSdkExporterMetricDataPointInflight() SdkExporterMetricDataPointInflight {
     ...
     return SdkExporterMetricDataPointInflight{ 
...
func (m SdkExporterMetricDataPointInflight) With(extras ...interface {OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
func (a SdkExporterMetricDataPointInflightExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkExporterMetricDataPointInflightExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
func (a SdkExporterMetricDataPointInflightExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a SdkExporterMetricDataPointInflightExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
