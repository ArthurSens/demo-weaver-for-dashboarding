...
const ComponentTypeZipkinHttpSpanExporter AttrComponentType = "zipkin_http_span_exporter"
...
const ComponentTypePrometheusHttpTextMetricExporter AttrComponentType = "prometheus_http_text_metric_exporter"
...
type AttrScopeSchemaUrl string // otel.scope.schema_url

func (AttrScopeSchemaUrl) Development() {}
func (AttrScopeSchemaUrl) Recommended() {}
func (AttrScopeSchemaUrl) Key() string { return "otel_scope_schema_url" }
func (a AttrScopeSchemaUrl) Value() string { return string(a) }
...
type AttrSpanParentOrigin string // otel.span.parent.origin

func (AttrSpanParentOrigin) Development() {}
func (AttrSpanParentOrigin) Recommended() {}
func (AttrSpanParentOrigin) Key() string { return "otel_span_parent_origin" }
func (a AttrSpanParentOrigin) Value() string { return string(a) }

const SpanParentOriginNone AttrSpanParentOrigin = "none"
const SpanParentOriginLocal AttrSpanParentOrigin = "local"
const SpanParentOriginRemote AttrSpanParentOrigin = "remote"
