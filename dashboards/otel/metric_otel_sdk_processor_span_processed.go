...
func NewSdkProcessorSpanProcessed() SdkProcessorSpanProcessed {
     labels := []string{error.AttrType("").Key(),AttrComponentName("").Key(),AttrComponentType("").Key(),}
     return SdkProcessorSpanProcessed{ 
        CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
            Name: "otel_sdk_processor_span_processed",
            Help: "The number of spans for which the processing has finished, either successful or failed.",
     }, labels)}
}

func (m SdkProcessorSpanProcessed) With(extras ...interface {ErrorType() error.AttrType;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;}) prometheus.Counter { 
...
// Deprecated: Use [SdkProcessorSpanProcessed.With] instead
func (m SdkProcessorSpanProcessed) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a SdkProcessorSpanProcessed) WithErrorType (attr interface { ErrorType() error.AttrType } ) SdkProcessorSpanProcessed {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a SdkProcessorSpanProcessed) WithComponentName (attr interface { OtelComponentName() AttrComponentName } ) SdkProcessorSpanProcessed {
    a.extra.AttrComponentName = attr.OtelComponentName()
    return a
}
func (a SdkProcessorSpanProcessed) WithComponentType (attr interface { OtelComponentType() AttrComponentType } ) SdkProcessorSpanProcessed {
...
func (a SdkProcessorSpanProcessedExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a SdkProcessorSpanProcessedExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkProcessorSpanProcessedExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
...
State {
    ...
    ctx: {
        ...
        "Name": "sdk.processor.span.processed",
