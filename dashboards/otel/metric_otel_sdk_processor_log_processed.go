...
func NewSdkProcessorLogProcessed() SdkProcessorLogProcessed {
     ...
     return SdkProcessorLogProcessed{ 
...
func (m SdkProcessorLogProcessed) With(extras ...interface {ErrorType() error.AttrType;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;}) prometheus.Counter { 
...
func (a SdkProcessorLogProcessedExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkProcessorLogProcessedExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
...
State {
    ...
    ctx: {
        ...
        "Name": "sdk.processor.log.processed",
