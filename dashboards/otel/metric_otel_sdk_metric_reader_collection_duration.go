...
func NewSdkMetricReaderCollectionDuration() SdkMetricReaderCollectionDuration {
     ...
     return SdkMetricReaderCollectionDuration{ 
...
func (m SdkMetricReaderCollectionDuration) With(extras ...interface {ErrorType() error.AttrType;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;}) prometheus.Observer { 
...
func (a SdkMetricReaderCollectionDurationExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkMetricReaderCollectionDurationExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
...
State {
    ...
    ctx: {
        ...
        "Name": "sdk.metric_reader.collection.duration",
