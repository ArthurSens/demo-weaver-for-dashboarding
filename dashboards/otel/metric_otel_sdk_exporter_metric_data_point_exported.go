...
type SdkExporterMetricDataPointExported struct {
     *prometheus.CounterVec
     extra SdkExporterMetricDataPointExportedExtra
}



func NewSdkExporterMetricDataPointExported() SdkExporterMetricDataPointExported {
     labels := []string{error.AttrType("").Key(),AttrComponentName("").Key(),AttrComponentType("").Key(),server.AttrAddress("").Key(),server.AttrPort("").Key(),}
     return SdkExporterMetricDataPointExported{ 
        CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
            Name: "otel_sdk_exporter_metric_data_point_exported",
            Help: "The number of metric data points for which the export has finished, either successful or failed.",
     }, labels)}
}

func (m SdkExporterMetricDataPointExported) With(extras ...interface {ErrorType() error.AttrType;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Counter { 
...
// Deprecated: Use [SdkExporterMetricDataPointExported.With] instead
func (m SdkExporterMetricDataPointExported) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a SdkExporterMetricDataPointExported) WithErrorType (attr interface { ErrorType() error.AttrType } ) SdkExporterMetricDataPointExported {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a SdkExporterMetricDataPointExported) WithComponentName (attr interface { OtelComponentName() AttrComponentName } ) SdkExporterMetricDataPointExported {
    a.extra.AttrComponentName = attr.OtelComponentName()
    return a
}
func (a SdkExporterMetricDataPointExported) WithComponentType (attr interface { OtelComponentType() AttrComponentType } ) SdkExporterMetricDataPointExported {
    a.extra.AttrComponentType = attr.OtelComponentType()
    return a
}
func (a SdkExporterMetricDataPointExported) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) SdkExporterMetricDataPointExported {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a SdkExporterMetricDataPointExported) WithServerPort (attr interface { ServerPort() server.AttrPort } ) SdkExporterMetricDataPointExported {
    a.extra.AttrServerPort = attr.ServerPort()
    return a
}


type SdkExporterMetricDataPointExportedExtra struct {
...
func (a SdkExporterMetricDataPointExportedExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a SdkExporterMetricDataPointExportedExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkExporterMetricDataPointExportedExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
func (a SdkExporterMetricDataPointExportedExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a SdkExporterMetricDataPointExportedExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "SdkExporterMetricDataPointExportedExtra",
        "Instr": "Counter",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "sdk.exporter.metric_data_point.exported",
