...
func NewSdkSpanLive() SdkSpanLive {
     ...
     return SdkSpanLive{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            ...
            Help: "The number of created spans with `recording=true` for which the end operation has not been called yet.",
     }, labels)}
}
...
func (a SdkSpanLiveExtra) OtelSpanSamplingResult() AttrSpanSamplingResult {return a.AttrSpanSamplingResult}
