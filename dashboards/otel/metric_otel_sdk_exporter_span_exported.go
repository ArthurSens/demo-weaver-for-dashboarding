...
func NewSdkExporterSpanExported() SdkExporterSpanExported {
     ...
     return SdkExporterSpanExported{ 
...
func (m SdkExporterSpanExported) With(extras ...interface {ErrorType() error.AttrType;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Counter { 
...
func (a SdkExporterSpanExportedExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkExporterSpanExportedExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
