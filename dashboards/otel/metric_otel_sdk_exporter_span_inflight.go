...
func NewSdkExporterSpanInflight() SdkExporterSpanInflight {
     ...
     return SdkExporterSpanInflight{ 
...
func (m SdkExporterSpanInflight) With(extras ...interface {OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
func (a SdkExporterSpanInflightExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkExporterSpanInflightExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
