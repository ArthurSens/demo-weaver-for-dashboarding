...
import (
      ...
      "github.com/ArthurSens/demo-weaver-for-dashboarding/dashboards/http"
      "github.com/ArthurSens/demo-weaver-for-dashboarding/dashboards/rpc"
...
func (m SdkExporterOperationDuration) With(extras ...interface {ErrorType() error.AttrType;HttpResponseStatusCode() http.AttrResponseStatusCode;OtelComponentName() AttrComponentName;OtelComponentType() AttrComponentType;RpcGrpcStatusCode() rpc.AttrGrpcStatusCode;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Observer { 
...
func (a SdkExporterOperationDuration) WithHttpResponseStatusCode (attr interface { HttpResponseStatusCode() http.AttrResponseStatusCode } ) SdkExporterOperationDuration {
...
func (a SdkExporterOperationDurationExtra) HttpResponseStatusCode() http.AttrResponseStatusCode {return a.AttrHttpResponseStatusCode}
func (a SdkExporterOperationDurationExtra) OtelComponentName() AttrComponentName {return a.AttrComponentName}
func (a SdkExporterOperationDurationExtra) OtelComponentType() AttrComponentType {return a.AttrComponentType}
func (a SdkExporterOperationDurationExtra) RpcGrpcStatusCode() rpc.AttrGrpcStatusCode {return a.AttrRpcGrpcStatusCode}
func (a SdkExporterOperationDurationExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
