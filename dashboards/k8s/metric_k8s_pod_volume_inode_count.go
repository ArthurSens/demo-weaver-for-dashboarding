...
type PodVolumeInodeCount struct {
     *prometheus.GaugeVec
     extra PodVolumeInodeCountExtra
}



func NewPodVolumeInodeCount() PodVolumeInodeCount {
     labels := []string{AttrVolumeName("").Key(),AttrVolumeType("").Key(),}
     return PodVolumeInodeCount{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_pod_volume_inode_count",
            Help: "The total inodes in the filesystem of the Pod's volume.",
     }, labels)}
}

func (m PodVolumeInodeCount) With(volumeName AttrVolumeName,extras ...interface {K8sVolumeType() AttrVolumeType;}) prometheus.Gauge { 
...
// Deprecated: Use [PodVolumeInodeCount.With] instead
func (m PodVolumeInodeCount) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a PodVolumeInodeCount) WithVolumeType (attr interface { K8sVolumeType() AttrVolumeType } ) PodVolumeInodeCount {
    a.extra.AttrVolumeType = attr.K8sVolumeType()
    return a
}


type PodVolumeInodeCountExtra struct {
// The type of the K8s volume
    AttrVolumeType AttrVolumeType `otel:"k8s.volume.type"`
}

func (a PodVolumeInodeCountExtra) K8sVolumeType() AttrVolumeType {return a.AttrVolumeType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PodVolumeInodeCountExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
