...
type ResourcequotaPersistentvolumeclaimCountUsed struct {
     *prometheus.GaugeVec
     extra ResourcequotaPersistentvolumeclaimCountUsedExtra
}



func NewResourcequotaPersistentvolumeclaimCountUsed() ResourcequotaPersistentvolumeclaimCountUsed {
     labels := []string{AttrStorageclassName("").Key(),}
     return ResourcequotaPersistentvolumeclaimCountUsed{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_resourcequota_persistentvolumeclaim_count_used",
            Help: "The total number of PersistentVolumeClaims that can exist in the namespace.
The value represents the current observed total usage of the resource in the namespace.",
     }, labels)}
}

func (m ResourcequotaPersistentvolumeclaimCountUsed) With(extras ...interface {K8sStorageclassName() AttrStorageclassName;}) prometheus.Gauge { 
...
// Deprecated: Use [ResourcequotaPersistentvolumeclaimCountUsed.With] instead
func (m ResourcequotaPersistentvolumeclaimCountUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a ResourcequotaPersistentvolumeclaimCountUsed) WithStorageclassName (attr interface { K8sStorageclassName() AttrStorageclassName } ) ResourcequotaPersistentvolumeclaimCountUsed {
    a.extra.AttrStorageclassName = attr.K8sStorageclassName()
    return a
}


type ResourcequotaPersistentvolumeclaimCountUsedExtra struct {
...
func (a ResourcequotaPersistentvolumeclaimCountUsedExtra) K8sStorageclassName() AttrStorageclassName {return a.AttrStorageclassName}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ResourcequotaPersistentvolumeclaimCountUsedExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "resourcequota.persistentvolumeclaim_count.used",
