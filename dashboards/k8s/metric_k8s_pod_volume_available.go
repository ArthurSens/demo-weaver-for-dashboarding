...
type PodVolumeAvailable struct {
     *prometheus.GaugeVec
     extra PodVolumeAvailableExtra
}



func NewPodVolumeAvailable() PodVolumeAvailable {
     labels := []string{AttrVolumeName("").Key(),AttrVolumeType("").Key(),}
     return PodVolumeAvailable{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_pod_volume_available",
            Help: "Pod volume storage space available.",
     }, labels)}
}

func (m PodVolumeAvailable) With(volumeName AttrVolumeName,extras ...interface {K8sVolumeType() AttrVolumeType;}) prometheus.Gauge { 
...
// Deprecated: Use [PodVolumeAvailable.With] instead
func (m PodVolumeAvailable) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a PodVolumeAvailable) WithVolumeType (attr interface { K8sVolumeType() AttrVolumeType } ) PodVolumeAvailable {
    a.extra.AttrVolumeType = attr.K8sVolumeType()
    return a
}


type PodVolumeAvailableExtra struct {
// The type of the K8s volume
    AttrVolumeType AttrVolumeType `otel:"k8s.volume.type"`
}

func (a PodVolumeAvailableExtra) K8sVolumeType() AttrVolumeType {return a.AttrVolumeType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PodVolumeAvailableExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
