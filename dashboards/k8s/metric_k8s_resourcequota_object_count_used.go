...
type ResourcequotaObjectCountUsed struct {
     *prometheus.GaugeVec
     extra ResourcequotaObjectCountUsedExtra
}



func NewResourcequotaObjectCountUsed() ResourcequotaObjectCountUsed {
     labels := []string{AttrResourcequotaResourceName("").Key(),}
     return ResourcequotaObjectCountUsed{ 
...
func (m ResourcequotaObjectCountUsed) With(resourcequotaResourceName AttrResourcequotaResourceName,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(resourcequotaResourceName.Value(),)
}

// Deprecated: Use [ResourcequotaObjectCountUsed.With] instead
func (m ResourcequotaObjectCountUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}



type ResourcequotaObjectCountUsedExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ResourcequotaObjectCountUsedExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "resourcequota.object_count.used",
