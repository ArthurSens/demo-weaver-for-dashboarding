...
type ResourcequotaHugepageCountRequestHard struct {
     *prometheus.GaugeVec
     extra ResourcequotaHugepageCountRequestHardExtra
}



func NewResourcequotaHugepageCountRequestHard() ResourcequotaHugepageCountRequestHard {
     labels := []string{AttrHugepageSize("").Key(),}
     return ResourcequotaHugepageCountRequestHard{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_resourcequota_hugepage_count_request_hard",
            Help: "The huge page requests in a specific namespace.
The value represents the configured quota limit of the resource in the namespace.",
     }, labels)}
}

func (m ResourcequotaHugepageCountRequestHard) With(hugepageSize AttrHugepageSize,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(hugepageSize.Value(),)
}

// Deprecated: Use [ResourcequotaHugepageCountRequestHard.With] instead
func (m ResourcequotaHugepageCountRequestHard) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}



type ResourcequotaHugepageCountRequestHardExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ResourcequotaHugepageCountRequestHardExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "resourcequota.hugepage_count.request.hard",
