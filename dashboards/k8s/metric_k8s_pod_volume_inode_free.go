...
type PodVolumeInodeFree struct {
     *prometheus.GaugeVec
     extra PodVolumeInodeFreeExtra
}



func NewPodVolumeInodeFree() PodVolumeInodeFree {
     labels := []string{AttrVolumeName("").Key(),AttrVolumeType("").Key(),}
     return PodVolumeInodeFree{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_pod_volume_inode_free",
            Help: "The free inodes in the filesystem of the Pod's volume.",
     }, labels)}
}

func (m PodVolumeInodeFree) With(volumeName AttrVolumeName,extras ...interface {K8sVolumeType() AttrVolumeType;}) prometheus.Gauge { 
...
// Deprecated: Use [PodVolumeInodeFree.With] instead
func (m PodVolumeInodeFree) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a PodVolumeInodeFree) WithVolumeType (attr interface { K8sVolumeType() AttrVolumeType } ) PodVolumeInodeFree {
    a.extra.AttrVolumeType = attr.K8sVolumeType()
    return a
}


type PodVolumeInodeFreeExtra struct {
// The type of the K8s volume
    AttrVolumeType AttrVolumeType `otel:"k8s.volume.type"`
}

func (a PodVolumeInodeFreeExtra) K8sVolumeType() AttrVolumeType {return a.AttrVolumeType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PodVolumeInodeFreeExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
