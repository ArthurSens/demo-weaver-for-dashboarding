...
type ResourcequotaHugepageCountRequestUsed struct {
     *prometheus.GaugeVec
     extra ResourcequotaHugepageCountRequestUsedExtra
}



func NewResourcequotaHugepageCountRequestUsed() ResourcequotaHugepageCountRequestUsed {
     labels := []string{AttrHugepageSize("").Key(),}
     return ResourcequotaHugepageCountRequestUsed{ 
...
func (m ResourcequotaHugepageCountRequestUsed) With(hugepageSize AttrHugepageSize,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(hugepageSize.Value(),)
}

// Deprecated: Use [ResourcequotaHugepageCountRequestUsed.With] instead
func (m ResourcequotaHugepageCountRequestUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}



type ResourcequotaHugepageCountRequestUsedExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ResourcequotaHugepageCountRequestUsedExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "resourcequota.hugepage_count.request.used",
