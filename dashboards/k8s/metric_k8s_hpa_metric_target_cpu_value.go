...
type HpaMetricTargetCpuValue struct {
     *prometheus.GaugeVec
     extra HpaMetricTargetCpuValueExtra
}



func NewHpaMetricTargetCpuValue() HpaMetricTargetCpuValue {
     labels := []string{AttrContainerName("").Key(),AttrHpaMetricType("").Key(),}
     return HpaMetricTargetCpuValue{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_hpa_metric_target_cpu_value",
            Help: "Target value for CPU resource in HPA config.",
     }, labels)}
}

func (m HpaMetricTargetCpuValue) With(extras ...interface {K8sContainerName() AttrContainerName;K8sHpaMetricType() AttrHpaMetricType;}) prometheus.Gauge { 
...
// Deprecated: Use [HpaMetricTargetCpuValue.With] instead
func (m HpaMetricTargetCpuValue) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a HpaMetricTargetCpuValue) WithContainerName (attr interface { K8sContainerName() AttrContainerName } ) HpaMetricTargetCpuValue {
    a.extra.AttrContainerName = attr.K8sContainerName()
    return a
}
func (a HpaMetricTargetCpuValue) WithHpaMetricType (attr interface { K8sHpaMetricType() AttrHpaMetricType } ) HpaMetricTargetCpuValue {
    a.extra.AttrHpaMetricType = attr.K8sHpaMetricType()
    return a
}


type HpaMetricTargetCpuValueExtra struct {
...
func (a HpaMetricTargetCpuValueExtra) K8sContainerName() AttrContainerName {return a.AttrContainerName}
func (a HpaMetricTargetCpuValueExtra) K8sHpaMetricType() AttrHpaMetricType {return a.AttrHpaMetricType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "HpaMetricTargetCpuValueExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "hpa.metric.target.cpu.value",
