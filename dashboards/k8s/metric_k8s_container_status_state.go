...
type ContainerStatusState struct {
     *prometheus.GaugeVec
     extra ContainerStatusStateExtra
}



func NewContainerStatusState() ContainerStatusState {
     labels := []string{AttrContainerStatusState("").Key(),}
     return ContainerStatusState{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_container_status_state",
            Help: "Describes the number of K8s containers that are currently in a given state.",
     }, labels)}
}

func (m ContainerStatusState) With(containerStatusState AttrContainerStatusState,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(containerStatusState.Value(),)
}

// Deprecated: Use [ContainerStatusState.With] instead
func (m ContainerStatusState) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}



type ContainerStatusStateExtra struct {
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ContainerStatusStateExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
