...
type ResourcequotaStorageRequestUsed struct {
     *prometheus.GaugeVec
     extra ResourcequotaStorageRequestUsedExtra
}



func NewResourcequotaStorageRequestUsed() ResourcequotaStorageRequestUsed {
...
func (m ResourcequotaStorageRequestUsed) With(extras ...interface {K8sStorageclassName() AttrStorageclassName;}) prometheus.Gauge { 
...
// Deprecated: Use [ResourcequotaStorageRequestUsed.With] instead
func (m ResourcequotaStorageRequestUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a ResourcequotaStorageRequestUsed) WithStorageclassName (attr interface { K8sStorageclassName() AttrStorageclassName } ) ResourcequotaStorageRequestUsed {
    a.extra.AttrStorageclassName = attr.K8sStorageclassName()
    return a
}


type ResourcequotaStorageRequestUsedExtra struct {
...
func (a ResourcequotaStorageRequestUsedExtra) K8sStorageclassName() AttrStorageclassName {return a.AttrStorageclassName}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ResourcequotaStorageRequestUsedExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "resourcequota.storage.request.used",
