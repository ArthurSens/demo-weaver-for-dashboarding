...
func (m NodeNetworkErrors) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
func (a NodeNetworkErrors) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NodeNetworkErrors {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NodeNetworkErrors) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NodeNetworkErrors {
...
func (a NodeNetworkErrorsExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a NodeNetworkErrorsExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
