...
func (m PodNetworkIo) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
func (a PodNetworkIo) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) PodNetworkIo {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a PodNetworkIo) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) PodNetworkIo {
...
func (a PodNetworkIoExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a PodNetworkIoExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
