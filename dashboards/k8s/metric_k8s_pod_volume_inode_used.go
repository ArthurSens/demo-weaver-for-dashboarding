...
type PodVolumeInodeUsed struct {
     *prometheus.GaugeVec
     extra PodVolumeInodeUsedExtra
}



func NewPodVolumeInodeUsed() PodVolumeInodeUsed {
     labels := []string{AttrVolumeName("").Key(),AttrVolumeType("").Key(),}
     return PodVolumeInodeUsed{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_pod_volume_inode_used",
            Help: "The inodes used by the filesystem of the Pod's volume.",
     }, labels)}
}

func (m PodVolumeInodeUsed) With(volumeName AttrVolumeName,extras ...interface {K8sVolumeType() AttrVolumeType;}) prometheus.Gauge { 
...
// Deprecated: Use [PodVolumeInodeUsed.With] instead
func (m PodVolumeInodeUsed) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a PodVolumeInodeUsed) WithVolumeType (attr interface { K8sVolumeType() AttrVolumeType } ) PodVolumeInodeUsed {
    a.extra.AttrVolumeType = attr.K8sVolumeType()
    return a
}


type PodVolumeInodeUsedExtra struct {
// The type of the K8s volume
    AttrVolumeType AttrVolumeType `otel:"k8s.volume.type"`
}

func (a PodVolumeInodeUsedExtra) K8sVolumeType() AttrVolumeType {return a.AttrVolumeType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PodVolumeInodeUsedExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
