...
type PodVolumeCapacity struct {
     *prometheus.GaugeVec
     extra PodVolumeCapacityExtra
}



func NewPodVolumeCapacity() PodVolumeCapacity {
     labels := []string{AttrVolumeName("").Key(),AttrVolumeType("").Key(),}
     return PodVolumeCapacity{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "k8s_pod_volume_capacity",
            Help: "Pod volume total capacity.",
     }, labels)}
}

func (m PodVolumeCapacity) With(volumeName AttrVolumeName,extras ...interface {K8sVolumeType() AttrVolumeType;}) prometheus.Gauge { 
...
// Deprecated: Use [PodVolumeCapacity.With] instead
func (m PodVolumeCapacity) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a PodVolumeCapacity) WithVolumeType (attr interface { K8sVolumeType() AttrVolumeType } ) PodVolumeCapacity {
    a.extra.AttrVolumeType = attr.K8sVolumeType()
    return a
}


type PodVolumeCapacityExtra struct {
// The type of the K8s volume
    AttrVolumeType AttrVolumeType `otel:"k8s.volume.type"`
}

func (a PodVolumeCapacityExtra) K8sVolumeType() AttrVolumeType {return a.AttrVolumeType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "PodVolumeCapacityExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
