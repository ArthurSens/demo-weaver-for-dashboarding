...
func NewPodNetworkErrors() PodNetworkErrors {
     ...
     return PodNetworkErrors{ 
        CounterVec: prometheus.NewCounterVec(prometheus.CounterOpts{
            ...
            Help: "Pod network errors.",
     }, labels)}
}

func (m PodNetworkErrors) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
// Deprecated: Use [PodNetworkErrors.With] instead
func (m PodNetworkErrors) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a PodNetworkErrors) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) PodNetworkErrors {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a PodNetworkErrors) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) PodNetworkErrors {
...
func (a PodNetworkErrorsExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a PodNetworkErrorsExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
