...
type HpaMetricTargetCpuAverageValue struct {
     *prometheus.GaugeVec
     extra HpaMetricTargetCpuAverageValueExtra
}



func NewHpaMetricTargetCpuAverageValue() HpaMetricTargetCpuAverageValue {
     ...
     return HpaMetricTargetCpuAverageValue{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            ...
            Help: "Target average value for CPU resource in HPA config.",
     }, labels)}
}

func (m HpaMetricTargetCpuAverageValue) With(extras ...interface {K8sContainerName() AttrContainerName;K8sHpaMetricType() AttrHpaMetricType;}) prometheus.Gauge { 
...
// Deprecated: Use [HpaMetricTargetCpuAverageValue.With] instead
func (m HpaMetricTargetCpuAverageValue) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a HpaMetricTargetCpuAverageValue) WithContainerName (attr interface { K8sContainerName() AttrContainerName } ) HpaMetricTargetCpuAverageValue {
    a.extra.AttrContainerName = attr.K8sContainerName()
    return a
}
func (a HpaMetricTargetCpuAverageValue) WithHpaMetricType (attr interface { K8sHpaMetricType() AttrHpaMetricType } ) HpaMetricTargetCpuAverageValue {
    a.extra.AttrHpaMetricType = attr.K8sHpaMetricType()
    return a
}


type HpaMetricTargetCpuAverageValueExtra struct {
...
func (a HpaMetricTargetCpuAverageValueExtra) K8sContainerName() AttrContainerName {return a.AttrContainerName}
func (a HpaMetricTargetCpuAverageValueExtra) K8sHpaMetricType() AttrHpaMetricType {return a.AttrHpaMetricType}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "HpaMetricTargetCpuAverageValueExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
        ...
        "Name": "hpa.metric.target.cpu.average_value",
