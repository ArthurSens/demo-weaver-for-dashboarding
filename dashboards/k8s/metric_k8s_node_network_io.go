...
func (m NodeNetworkIo) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
// Deprecated: Use [NodeNetworkIo.With] instead
func (m NodeNetworkIo) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a NodeNetworkIo) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NodeNetworkIo {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NodeNetworkIo) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NodeNetworkIo {
...
func (a NodeNetworkIoExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a NodeNetworkIoExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
