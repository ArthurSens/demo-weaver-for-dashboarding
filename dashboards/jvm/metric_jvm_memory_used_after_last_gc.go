...
func (m MemoryUsedAfterLastGc) With(extras ...interface {JvmMemoryPoolName() AttrMemoryPoolName;JvmMemoryType() AttrMemoryType;}) prometheus.Gauge { 
...
func (a MemoryUsedAfterLastGcExtra) JvmMemoryPoolName() AttrMemoryPoolName {return a.AttrMemoryPoolName}
