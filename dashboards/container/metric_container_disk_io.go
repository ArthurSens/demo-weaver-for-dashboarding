...
import (
      ...
      "github.com/ArthurSens/demo-weaver-for-dashboarding/dashboards/system"
)
...
func (m DiskIo) With(extras ...interface {DiskIoDirection() disk.AttrIoDirection;SystemDevice() system.AttrDevice;}) prometheus.Counter { 
