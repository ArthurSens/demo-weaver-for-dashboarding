...
func (m NetworkIo) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
func (a NetworkIo) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NetworkIo {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NetworkIo) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NetworkIo {
...
func (a NetworkIoExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
