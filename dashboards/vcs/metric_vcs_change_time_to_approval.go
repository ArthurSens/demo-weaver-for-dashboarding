...
func (m ChangeTimeToApproval) With(refHeadName AttrRefHeadName,repositoryUrlFull AttrRepositoryUrlFull,extras ...interface {VcsOwnerName() AttrOwnerName;VcsRefBaseName() AttrRefBaseName;VcsRepositoryName() AttrRepositoryName;VcsProviderName() AttrProviderName;VcsRefBaseRevision() AttrRefBaseRevision;VcsRefHeadRevision() AttrRefHeadRevision;}) prometheus.Gauge { 
...
func (a ChangeTimeToApprovalExtra) VcsRepositoryName() AttrRepositoryName {return a.AttrRepositoryName}
func (a ChangeTimeToApprovalExtra) VcsProviderName() AttrProviderName {return a.AttrProviderName}
func (a ChangeTimeToApprovalExtra) VcsRefBaseRevision() AttrRefBaseRevision {return a.AttrRefBaseRevision}
func (a ChangeTimeToApprovalExtra) VcsRefHeadRevision() AttrRefHeadRevision {return a.AttrRefHeadRevision}
