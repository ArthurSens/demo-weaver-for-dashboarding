...
func (m ChangeDuration) With(changeState AttrChangeState,refHeadName AttrRefHeadName,repositoryUrlFull AttrRepositoryUrlFull,extras ...interface {VcsOwnerName() AttrOwnerName;VcsRepositoryName() AttrRepositoryName;VcsProviderName() AttrProviderName;}) prometheus.Gauge { 
