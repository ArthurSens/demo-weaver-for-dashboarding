...
func (m ContributorCount) With(repositoryUrlFull AttrRepositoryUrlFull,extras ...interface {VcsOwnerName() AttrOwnerName;VcsRepositoryName() AttrRepositoryName;VcsProviderName() AttrProviderName;}) prometheus.Gauge { 
