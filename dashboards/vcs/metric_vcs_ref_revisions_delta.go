...
func NewRefRevisionsDelta() RefRevisionsDelta {
     labels := []string{AttrRefBaseName("").Key(),AttrRefBaseType("").Key(),AttrRefHeadName("").Key(),AttrRefHeadType("").Key(),AttrRepositoryUrlFull("").Key(),AttrRevisionDeltaDirection("").Key(),AttrChangeId("").Key(),AttrOwnerName("").Key(),AttrRepositoryName("").Key(),AttrProviderName("").Key(),}
     return RefRevisionsDelta{ 
...
func (m RefRevisionsDelta) With(refBaseName AttrRefBaseName,refBaseKind AttrRefBaseType,refHeadName AttrRefHeadName,refHeadKind AttrRefHeadType,repositoryUrlFull AttrRepositoryUrlFull,revisionDeltaDirection AttrRevisionDeltaDirection,extras ...interface {VcsChangeId() AttrChangeId;VcsOwnerName() AttrOwnerName;VcsRepositoryName() AttrRepositoryName;VcsProviderName() AttrProviderName;}) prometheus.Gauge { 
        if extras == nil { extras = append(extras, m.extra) }
        extra := extras[0]
    
    return m.GaugeVec.WithLabelValues(refBaseName.Value(),refBaseKind.Value(),refHeadName.Value(),refHeadKind.Value(),repositoryUrlFull.Value(),revisionDeltaDirection.Value(),extra.VcsChangeId().Value(),extra.VcsOwnerName().Value(),extra.VcsRepositoryName().Value(),extra.VcsProviderName().Value(),)
}

// Deprecated: Use [RefRevisionsDelta.With] instead
func (m RefRevisionsDelta) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a RefRevisionsDelta) WithChangeId (attr interface { VcsChangeId() AttrChangeId } ) RefRevisionsDelta {
    a.extra.AttrChangeId = attr.VcsChangeId()
    return a
}
func (a RefRevisionsDelta) WithOwnerName (attr interface { VcsOwnerName() AttrOwnerName } ) RefRevisionsDelta {
    a.extra.AttrOwnerName = attr.VcsOwnerName()
    return a
}
func (a RefRevisionsDelta) WithRepositoryName (attr interface { VcsRepositoryName() AttrRepositoryName } ) RefRevisionsDelta {
    a.extra.AttrRepositoryName = attr.VcsRepositoryName()
    return a
}
func (a RefRevisionsDelta) WithProviderName (attr interface { VcsProviderName() AttrProviderName } ) RefRevisionsDelta {
...
func (a RefRevisionsDeltaExtra) VcsChangeId() AttrChangeId {return a.AttrChangeId}
func (a RefRevisionsDeltaExtra) VcsOwnerName() AttrOwnerName {return a.AttrOwnerName}
func (a RefRevisionsDeltaExtra) VcsRepositoryName() AttrRepositoryName {return a.AttrRepositoryName}
func (a RefRevisionsDeltaExtra) VcsProviderName() AttrProviderName {return a.AttrProviderName}
