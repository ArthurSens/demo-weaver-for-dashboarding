...
func (AttrCosmosdbOperationContactedRegions) Key() string { return "azure_cosmosdb_operation_contacted_regions" }
...
func (AttrCosmosdbOperationRequestCharge) Key() string { return "azure_cosmosdb_operation_request_charge" }
...
func (AttrCosmosdbResponseSubStatusCode) Key() string { return "azure_cosmosdb_response_sub_status_code" }
...
type AttrResourceProviderNamespace string // azure.resource_provider.namespace

func (AttrResourceProviderNamespace) Development() {}
func (AttrResourceProviderNamespace) Recommended() {}
func (AttrResourceProviderNamespace) Key() string { return "azure_resource_provider_namespace" }
func (a AttrResourceProviderNamespace) Value() string { return string(a) }
...
type AttrServiceRequestId string // azure.service.request.id

func (AttrServiceRequestId) Development() {}
func (AttrServiceRequestId) Recommended() {}
func (AttrServiceRequestId) Key() string { return "azure_service_request_id" }
