...
func NewCosmosdbClientActiveInstanceCount() CosmosdbClientActiveInstanceCount {
     ...
     return CosmosdbClientActiveInstanceCount{ 
...
func (m CosmosdbClientActiveInstanceCount) With(extras ...interface {ServerPort() server.AttrPort;ServerAddress() server.AttrAddress;}) prometheus.Gauge { 
...
func (a CosmosdbClientActiveInstanceCountExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
