...
func (m ServerRequestDuration) With(operationName AttrOperationName,providerName AttrProviderName,extras ...interface {ErrorType() error.AttrType;GenAiRequestModel() AttrRequestModel;ServerPort() server.AttrPort;GenAiResponseModel() AttrResponseModel;ServerAddress() server.AttrAddress;}) prometheus.Observer { 
...
func (a ServerRequestDurationExtra) GenAiResponseModel() AttrResponseModel {return a.AttrResponseModel}
