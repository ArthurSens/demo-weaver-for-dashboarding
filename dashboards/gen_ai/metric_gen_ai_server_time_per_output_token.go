...
func (m ServerTimePerOutputToken) With(operationName AttrOperationName,providerName AttrProviderName,extras ...interface {GenAiRequestModel() AttrRequestModel;ServerPort() server.AttrPort;GenAiResponseModel() AttrResponseModel;ServerAddress() server.AttrAddress;}) prometheus.Observer { 
...
func (a ServerTimePerOutputTokenExtra) GenAiRequestModel() AttrRequestModel {return a.AttrRequestModel}
func (a ServerTimePerOutputTokenExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
func (a ServerTimePerOutputTokenExtra) GenAiResponseModel() AttrResponseModel {return a.AttrResponseModel}
