...
type AttrAnswers string // dns.answers

func (AttrAnswers) Development() {}
func (AttrAnswers) Recommended() {}
func (AttrAnswers) Key() string { return "dns_answers" }
func (a AttrAnswers) Value() string { return string(a) }
