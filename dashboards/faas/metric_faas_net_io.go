...
func NewNetIo() NetIo {
     ...
     return NetIo{ 
        HistogramVec: prometheus.NewHistogramVec(prometheus.HistogramOpts{
            Name: "faas_net_io",
            Help: "Distribution of net I/O usage per invocation.",
     }, labels)}
}

func (m NetIo) With(extras ...interface {FaasTrigger() AttrTrigger;}) prometheus.Observer { 
...
// Deprecated: Use [NetIo.With] instead
func (m NetIo) WithLabelValues(lvs ...string) prometheus.Observer {
    return m.HistogramVec.WithLabelValues(lvs...)
}

func (a NetIo) WithTrigger (attr interface { FaasTrigger() AttrTrigger } ) NetIo {
...
func (a NetIoExtra) FaasTrigger() AttrTrigger {return a.AttrTrigger}
