...
func NewUpgradedConnections() UpgradedConnections {
     ...
     return UpgradedConnections{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "kestrel_upgraded_connections",
            Help: "Number of connections that are currently upgraded (WebSockets). .",
     }, labels)}
}

func (m UpgradedConnections) With(extras ...interface {NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
// Deprecated: Use [UpgradedConnections.With] instead
func (m UpgradedConnections) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a UpgradedConnections) WithNetworkTransport (attr interface { NetworkTransport() network.AttrTransport } ) UpgradedConnections {
    a.extra.AttrNetworkTransport = attr.NetworkTransport()
    return a
}
func (a UpgradedConnections) WithNetworkType (attr interface { NetworkType() network.AttrType } ) UpgradedConnections {
    a.extra.AttrNetworkType = attr.NetworkType()
    return a
}
func (a UpgradedConnections) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) UpgradedConnections {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a UpgradedConnections) WithServerPort (attr interface { ServerPort() server.AttrPort } ) UpgradedConnections {
...
func (a UpgradedConnectionsExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
func (a UpgradedConnectionsExtra) NetworkType() network.AttrType {return a.AttrNetworkType}
func (a UpgradedConnectionsExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a UpgradedConnectionsExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
