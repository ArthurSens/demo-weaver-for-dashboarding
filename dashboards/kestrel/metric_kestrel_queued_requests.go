...
func (m QueuedRequests) With(extras ...interface {NetworkProtocolName() network.AttrProtocolName;NetworkProtocolVersion() network.AttrProtocolVersion;NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
func (a QueuedRequests) WithNetworkProtocolName (attr interface { NetworkProtocolName() network.AttrProtocolName } ) QueuedRequests {
    a.extra.AttrNetworkProtocolName = attr.NetworkProtocolName()
    return a
}
func (a QueuedRequests) WithNetworkProtocolVersion (attr interface { NetworkProtocolVersion() network.AttrProtocolVersion } ) QueuedRequests {
...
func (a QueuedRequestsExtra) NetworkProtocolName() network.AttrProtocolName {return a.AttrNetworkProtocolName}
func (a QueuedRequestsExtra) NetworkProtocolVersion() network.AttrProtocolVersion {return a.AttrNetworkProtocolVersion}
