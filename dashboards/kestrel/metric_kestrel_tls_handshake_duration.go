...
func (m TlsHandshakeDuration) With(extras ...interface {ErrorType() error.AttrType;NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;TlsProtocolVersion() tls.AttrProtocolVersion;}) prometheus.Observer { 
...
func (a TlsHandshakeDuration) WithTlsProtocolVersion (attr interface { TlsProtocolVersion() tls.AttrProtocolVersion } ) TlsHandshakeDuration {
...
func (a TlsHandshakeDurationExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
...
func (a TlsHandshakeDurationExtra) TlsProtocolVersion() tls.AttrProtocolVersion {return a.AttrTlsProtocolVersion}
