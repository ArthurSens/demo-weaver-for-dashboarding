...
func (m QueuedConnections) With(extras ...interface {NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
// Deprecated: Use [QueuedConnections.With] instead
func (m QueuedConnections) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a QueuedConnections) WithNetworkTransport (attr interface { NetworkTransport() network.AttrTransport } ) QueuedConnections {
    a.extra.AttrNetworkTransport = attr.NetworkTransport()
    return a
}
func (a QueuedConnections) WithNetworkType (attr interface { NetworkType() network.AttrType } ) QueuedConnections {
    a.extra.AttrNetworkType = attr.NetworkType()
    return a
}
func (a QueuedConnections) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) QueuedConnections {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a QueuedConnections) WithServerPort (attr interface { ServerPort() server.AttrPort } ) QueuedConnections {
...
func (a QueuedConnectionsExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
func (a QueuedConnectionsExtra) NetworkType() network.AttrType {return a.AttrNetworkType}
func (a QueuedConnectionsExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a QueuedConnectionsExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "QueuedConnectionsExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
