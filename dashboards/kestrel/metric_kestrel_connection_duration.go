...
import (
      ...
      "github.com/ArthurSens/demo-weaver-for-dashboarding/dashboards/tls"
)
...
func (m ConnectionDuration) With(extras ...interface {ErrorType() error.AttrType;NetworkProtocolName() network.AttrProtocolName;NetworkProtocolVersion() network.AttrProtocolVersion;NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;TlsProtocolVersion() tls.AttrProtocolVersion;}) prometheus.Observer { 
...
func (a ConnectionDuration) WithNetworkProtocolName (attr interface { NetworkProtocolName() network.AttrProtocolName } ) ConnectionDuration {
    a.extra.AttrNetworkProtocolName = attr.NetworkProtocolName()
    return a
}
func (a ConnectionDuration) WithNetworkProtocolVersion (attr interface { NetworkProtocolVersion() network.AttrProtocolVersion } ) ConnectionDuration {
...
func (a ConnectionDuration) WithTlsProtocolVersion (attr interface { TlsProtocolVersion() tls.AttrProtocolVersion } ) ConnectionDuration {
...
func (a ConnectionDurationExtra) NetworkProtocolName() network.AttrProtocolName {return a.AttrNetworkProtocolName}
func (a ConnectionDurationExtra) NetworkProtocolVersion() network.AttrProtocolVersion {return a.AttrNetworkProtocolVersion}
func (a ConnectionDurationExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
...
func (a ConnectionDurationExtra) TlsProtocolVersion() tls.AttrProtocolVersion {return a.AttrTlsProtocolVersion}
