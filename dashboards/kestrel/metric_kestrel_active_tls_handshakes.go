...
func (m ActiveTlsHandshakes) With(extras ...interface {NetworkTransport() network.AttrTransport;NetworkType() network.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Gauge { 
...
func (a ActiveTlsHandshakesExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
