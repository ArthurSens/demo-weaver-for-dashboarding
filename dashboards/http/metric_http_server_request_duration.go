...
func (a ServerRequestDuration) WithNetworkProtocolName (attr interface { NetworkProtocolName() network.AttrProtocolName } ) ServerRequestDuration {
    a.extra.AttrNetworkProtocolName = attr.NetworkProtocolName()
    return a
}
func (a ServerRequestDuration) WithNetworkProtocolVersion (attr interface { NetworkProtocolVersion() network.AttrProtocolVersion } ) ServerRequestDuration {
...
func (a ServerRequestDuration) WithUserAgentSyntheticType (attr interface { UserAgentSyntheticType() user_agent.AttrSyntheticType } ) ServerRequestDuration {
...
func (a ServerRequestDurationExtra) HttpResponseStatusCode() AttrResponseStatusCode {return a.AttrResponseStatusCode}
func (a ServerRequestDurationExtra) HttpRoute() AttrRoute {return a.AttrRoute}
func (a ServerRequestDurationExtra) NetworkProtocolName() network.AttrProtocolName {return a.AttrNetworkProtocolName}
func (a ServerRequestDurationExtra) NetworkProtocolVersion() network.AttrProtocolVersion {return a.AttrNetworkProtocolVersion}
...
func (a ServerRequestDurationExtra) UserAgentSyntheticType() user_agent.AttrSyntheticType {return a.AttrUserAgentSyntheticType}
