...
func (a ServerResponseBodySize) WithNetworkProtocolName (attr interface { NetworkProtocolName() network.AttrProtocolName } ) ServerResponseBodySize {
    a.extra.AttrNetworkProtocolName = attr.NetworkProtocolName()
    return a
}
func (a ServerResponseBodySize) WithNetworkProtocolVersion (attr interface { NetworkProtocolVersion() network.AttrProtocolVersion } ) ServerResponseBodySize {
...
func (a ServerResponseBodySize) WithUserAgentSyntheticType (attr interface { UserAgentSyntheticType() user_agent.AttrSyntheticType } ) ServerResponseBodySize {
...
func (a ServerResponseBodySizeExtra) HttpResponseStatusCode() AttrResponseStatusCode {return a.AttrResponseStatusCode}
func (a ServerResponseBodySizeExtra) HttpRoute() AttrRoute {return a.AttrRoute}
func (a ServerResponseBodySizeExtra) NetworkProtocolName() network.AttrProtocolName {return a.AttrNetworkProtocolName}
func (a ServerResponseBodySizeExtra) NetworkProtocolVersion() network.AttrProtocolVersion {return a.AttrNetworkProtocolVersion}
...
func (a ServerResponseBodySizeExtra) UserAgentSyntheticType() user_agent.AttrSyntheticType {return a.AttrUserAgentSyntheticType}
