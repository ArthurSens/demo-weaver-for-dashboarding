...
func (AttrRequestContentLengthUncompressed) Key() string { return "http_request_content_length_uncompressed" }
...
func (AttrResponseContentLengthUncompressed) Key() string { return "http_response_content_length_uncompressed" }
