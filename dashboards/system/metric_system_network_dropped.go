...
func (m NetworkDropped) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
func (a NetworkDropped) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NetworkDropped {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NetworkDropped) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NetworkDropped {
...
func (a NetworkDroppedExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a NetworkDroppedExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
