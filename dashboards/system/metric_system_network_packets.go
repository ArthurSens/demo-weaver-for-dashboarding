...
func (m NetworkPackets) With(extras ...interface {NetworkIoDirection() network.AttrIoDirection;SystemDevice() AttrDevice;}) prometheus.Counter { 
...
func (a NetworkPackets) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NetworkPackets {
...
func (a NetworkPacketsExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
