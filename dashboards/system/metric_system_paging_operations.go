...
func (m PagingOperations) With(extras ...interface {SystemPagingDirection() AttrPagingDirection;SystemPagingType() AttrPagingType;}) prometheus.Counter { 
...
func (a PagingOperationsExtra) SystemPagingDirection() AttrPagingDirection {return a.AttrPagingDirection}
