...
func (m NetworkErrors) With(extras ...interface {NetworkInterfaceName() network.AttrInterfaceName;NetworkIoDirection() network.AttrIoDirection;}) prometheus.Counter { 
...
func (a NetworkErrors) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NetworkErrors {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NetworkErrors) WithNetworkIoDirection (attr interface { NetworkIoDirection() network.AttrIoDirection } ) NetworkErrors {
...
func (a NetworkErrorsExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a NetworkErrorsExtra) NetworkIoDirection() network.AttrIoDirection {return a.AttrNetworkIoDirection}
