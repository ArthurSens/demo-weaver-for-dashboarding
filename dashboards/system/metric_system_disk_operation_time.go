...
func (m DiskOperationTime) With(extras ...interface {DiskIoDirection() disk.AttrIoDirection;SystemDevice() AttrDevice;}) prometheus.Counter { 
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "DiskOperationTimeExtra",
        "Instr": "Counter",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
