...
func (m FilesystemUsage) With(extras ...interface {SystemDevice() AttrDevice;SystemFilesystemMode() AttrFilesystemMode;SystemFilesystemMountpoint() AttrFilesystemMountpoint;SystemFilesystemState() AttrFilesystemState;SystemFilesystemType() AttrFilesystemType;}) prometheus.Gauge { 
...
func (a FilesystemUsage) WithFilesystemMountpoint (attr interface { SystemFilesystemMountpoint() AttrFilesystemMountpoint } ) FilesystemUsage {
...
func (a FilesystemUsageExtra) SystemFilesystemMountpoint() AttrFilesystemMountpoint {return a.AttrFilesystemMountpoint}
func (a FilesystemUsageExtra) SystemFilesystemState() AttrFilesystemState {return a.AttrFilesystemState}
