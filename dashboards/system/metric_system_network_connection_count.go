...
type NetworkConnectionCount struct {
     *prometheus.GaugeVec
     extra NetworkConnectionCountExtra
}



func NewNetworkConnectionCount() NetworkConnectionCount {
...
func (m NetworkConnectionCount) With(extras ...interface {NetworkConnectionState() network.AttrConnectionState;NetworkInterfaceName() network.AttrInterfaceName;NetworkTransport() network.AttrTransport;}) prometheus.Gauge { 
...
// Deprecated: Use [NetworkConnectionCount.With] instead
func (m NetworkConnectionCount) WithLabelValues(lvs ...string) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(lvs...)
}

func (a NetworkConnectionCount) WithNetworkConnectionState (attr interface { NetworkConnectionState() network.AttrConnectionState } ) NetworkConnectionCount {
    a.extra.AttrNetworkConnectionState = attr.NetworkConnectionState()
    return a
}
func (a NetworkConnectionCount) WithNetworkInterfaceName (attr interface { NetworkInterfaceName() network.AttrInterfaceName } ) NetworkConnectionCount {
    a.extra.AttrNetworkInterfaceName = attr.NetworkInterfaceName()
    return a
}
func (a NetworkConnectionCount) WithNetworkTransport (attr interface { NetworkTransport() network.AttrTransport } ) NetworkConnectionCount {
    a.extra.AttrNetworkTransport = attr.NetworkTransport()
    return a
}


type NetworkConnectionCountExtra struct {
...
func (a NetworkConnectionCountExtra) NetworkConnectionState() network.AttrConnectionState {return a.AttrNetworkConnectionState}
func (a NetworkConnectionCountExtra) NetworkInterfaceName() network.AttrInterfaceName {return a.AttrNetworkInterfaceName}
func (a NetworkConnectionCountExtra) NetworkTransport() network.AttrTransport {return a.AttrNetworkTransport}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "NetworkConnectionCountExtra",
        "Instr": "Gauge",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
