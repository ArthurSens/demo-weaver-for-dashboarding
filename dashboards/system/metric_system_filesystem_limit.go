...
func (m FilesystemLimit) With(extras ...interface {SystemDevice() AttrDevice;SystemFilesystemMode() AttrFilesystemMode;SystemFilesystemMountpoint() AttrFilesystemMountpoint;SystemFilesystemType() AttrFilesystemType;}) prometheus.Gauge { 
...
func (a FilesystemLimit) WithFilesystemMountpoint (attr interface { SystemFilesystemMountpoint() AttrFilesystemMountpoint } ) FilesystemLimit {
...
func (a FilesystemLimitExtra) SystemFilesystemMountpoint() AttrFilesystemMountpoint {return a.AttrFilesystemMountpoint}
