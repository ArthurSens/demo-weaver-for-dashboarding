...
import (
      ...
      "github.com/ArthurSens/demo-weaver-for-dashboarding/dashboards/disk"
)

// 
type DiskOperations struct {
     *prometheus.CounterVec
     extra DiskOperationsExtra
}



func NewDiskOperations() DiskOperations {
...
func (m DiskOperations) With(extras ...interface {DiskIoDirection() disk.AttrIoDirection;SystemDevice() AttrDevice;}) prometheus.Counter { 
...
// Deprecated: Use [DiskOperations.With] instead
func (m DiskOperations) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a DiskOperations) WithDiskIoDirection (attr interface { DiskIoDirection() disk.AttrIoDirection } ) DiskOperations {
    a.extra.AttrDiskIoDirection = attr.DiskIoDirection()
    return a
}
func (a DiskOperations) WithDevice (attr interface { SystemDevice() AttrDevice } ) DiskOperations {
    a.extra.AttrDevice = attr.SystemDevice()
    return a
}


type DiskOperationsExtra struct {
...
func (a DiskOperationsExtra) DiskIoDirection() disk.AttrIoDirection {return a.AttrDiskIoDirection}
func (a DiskOperationsExtra) SystemDevice() AttrDevice {return a.AttrDevice}
