...
func (AttrEventhubsMessageEnqueuedTime) Key() string { return "messaging_eventhubs_message_enqueued_time" }
...
func (AttrGcpPubsubMessageAckDeadline) Key() string { return "messaging_gcp_pubsub_message_ack_deadline" }
...
func (AttrGcpPubsubMessageDeliveryAttempt) Key() string { return "messaging_gcp_pubsub_message_delivery_attempt" }
...
func (AttrGcpPubsubMessageOrderingKey) Key() string { return "messaging_gcp_pubsub_message_ordering_key" }
...
func (AttrRabbitmqDestinationRoutingKey) Key() string { return "messaging_rabbitmq_destination_routing_key" }
...
func (AttrRocketmqMessageDelayTimeLevel) Key() string { return "messaging_rocketmq_message_delay_time_level" }
...
func (AttrRocketmqMessageDeliveryTimestamp) Key() string { return "messaging_rocketmq_message_delivery_timestamp" }
...
func (AttrServicebusDestinationSubscriptionName) Key() string { return "messaging_servicebus_destination_subscription_name" }
...
func (AttrServicebusMessageDeliveryCount) Key() string { return "messaging_servicebus_message_delivery_count" }
...
func (AttrServicebusMessageEnqueuedTime) Key() string { return "messaging_servicebus_message_enqueued_time" }
