...
func (m PublishDuration) With(operationName AttrOperationName,extras ...interface {ErrorType() error.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Observer { 
...
State {
    ...
    ctx: {
        ...
        "Name": "publish.duration",
        "Type": "PublishDuration",
        "attributes": [
            {
