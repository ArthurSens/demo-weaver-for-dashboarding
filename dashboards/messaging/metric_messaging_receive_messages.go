...
func (m ReceiveMessages) With(operationName AttrOperationName,extras ...interface {ErrorType() error.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Counter { 
