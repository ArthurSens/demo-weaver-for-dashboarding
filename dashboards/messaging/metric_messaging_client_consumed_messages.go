...
func (a ClientConsumedMessages) WithDestinationSubscriptionName (attr interface { MessagingDestinationSubscriptionName() AttrDestinationSubscriptionName } ) ClientConsumedMessages {
    a.extra.AttrDestinationSubscriptionName = attr.MessagingDestinationSubscriptionName()
    return a
}
func (a ClientConsumedMessages) WithDestinationTemplate (attr interface { MessagingDestinationTemplate() AttrDestinationTemplate } ) ClientConsumedMessages {
...
func (a ClientConsumedMessages) WithDestinationPartitionId (attr interface { MessagingDestinationPartitionId() AttrDestinationPartitionId } ) ClientConsumedMessages {
...
func (a ClientConsumedMessagesExtra) MessagingConsumerGroupName() AttrConsumerGroupName {return a.AttrConsumerGroupName}
func (a ClientConsumedMessagesExtra) MessagingDestinationName() AttrDestinationName {return a.AttrDestinationName}
func (a ClientConsumedMessagesExtra) MessagingDestinationSubscriptionName() AttrDestinationSubscriptionName {return a.AttrDestinationSubscriptionName}
func (a ClientConsumedMessagesExtra) MessagingDestinationTemplate() AttrDestinationTemplate {return a.AttrDestinationTemplate}
func (a ClientConsumedMessagesExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a ClientConsumedMessagesExtra) MessagingDestinationPartitionId() AttrDestinationPartitionId {return a.AttrDestinationPartitionId}
