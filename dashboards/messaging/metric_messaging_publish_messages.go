...
func (m PublishMessages) With(operationName AttrOperationName,extras ...interface {ErrorType() error.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Counter { 
...
// Deprecated: Use [PublishMessages.With] instead
func (m PublishMessages) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a PublishMessages) WithErrorType (attr interface { ErrorType() error.AttrType } ) PublishMessages {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a PublishMessages) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) PublishMessages {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a PublishMessages) WithServerPort (attr interface { ServerPort() server.AttrPort } ) PublishMessages {
...
func (a PublishMessagesExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a PublishMessagesExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a PublishMessagesExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
