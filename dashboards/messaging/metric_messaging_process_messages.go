...
func NewProcessMessages() ProcessMessages {
...
func (m ProcessMessages) With(operationName AttrOperationName,extras ...interface {ErrorType() error.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Counter { 
...
// Deprecated: Use [ProcessMessages.With] instead
func (m ProcessMessages) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a ProcessMessages) WithErrorType (attr interface { ErrorType() error.AttrType } ) ProcessMessages {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a ProcessMessages) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) ProcessMessages {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a ProcessMessages) WithServerPort (attr interface { ServerPort() server.AttrPort } ) ProcessMessages {
...
func (a ProcessMessagesExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a ProcessMessagesExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a ProcessMessagesExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
