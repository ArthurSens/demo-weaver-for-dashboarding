...
func (a ProcessDuration) WithDestinationSubscriptionName (attr interface { MessagingDestinationSubscriptionName() AttrDestinationSubscriptionName } ) ProcessDuration {
    a.extra.AttrDestinationSubscriptionName = attr.MessagingDestinationSubscriptionName()
    return a
}
func (a ProcessDuration) WithDestinationTemplate (attr interface { MessagingDestinationTemplate() AttrDestinationTemplate } ) ProcessDuration {
...
func (a ProcessDuration) WithDestinationPartitionId (attr interface { MessagingDestinationPartitionId() AttrDestinationPartitionId } ) ProcessDuration {
...
func (a ProcessDurationExtra) MessagingConsumerGroupName() AttrConsumerGroupName {return a.AttrConsumerGroupName}
func (a ProcessDurationExtra) MessagingDestinationName() AttrDestinationName {return a.AttrDestinationName}
func (a ProcessDurationExtra) MessagingDestinationSubscriptionName() AttrDestinationSubscriptionName {return a.AttrDestinationSubscriptionName}
func (a ProcessDurationExtra) MessagingDestinationTemplate() AttrDestinationTemplate {return a.AttrDestinationTemplate}
func (a ProcessDurationExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a ProcessDurationExtra) MessagingDestinationPartitionId() AttrDestinationPartitionId {return a.AttrDestinationPartitionId}
