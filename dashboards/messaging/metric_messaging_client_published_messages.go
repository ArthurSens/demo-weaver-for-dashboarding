...
func NewClientPublishedMessages() ClientPublishedMessages {
     ...
     return ClientPublishedMessages{ 
...
func (m ClientPublishedMessages) With(operationName AttrOperationName,system AttrSystem,extras ...interface {ErrorType() error.AttrType;MessagingDestinationName() AttrDestinationName;MessagingDestinationTemplate() AttrDestinationTemplate;ServerAddress() server.AttrAddress;MessagingDestinationPartitionId() AttrDestinationPartitionId;ServerPort() server.AttrPort;}) prometheus.Counter { 
...
// Deprecated: Use [ClientPublishedMessages.With] instead
func (m ClientPublishedMessages) WithLabelValues(lvs ...string) prometheus.Counter {
    return m.CounterVec.WithLabelValues(lvs...)
}

func (a ClientPublishedMessages) WithErrorType (attr interface { ErrorType() error.AttrType } ) ClientPublishedMessages {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a ClientPublishedMessages) WithDestinationName (attr interface { MessagingDestinationName() AttrDestinationName } ) ClientPublishedMessages {
    a.extra.AttrDestinationName = attr.MessagingDestinationName()
    return a
}
func (a ClientPublishedMessages) WithDestinationTemplate (attr interface { MessagingDestinationTemplate() AttrDestinationTemplate } ) ClientPublishedMessages {
    a.extra.AttrDestinationTemplate = attr.MessagingDestinationTemplate()
    return a
}
func (a ClientPublishedMessages) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) ClientPublishedMessages {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a ClientPublishedMessages) WithDestinationPartitionId (attr interface { MessagingDestinationPartitionId() AttrDestinationPartitionId } ) ClientPublishedMessages {
    a.extra.AttrDestinationPartitionId = attr.MessagingDestinationPartitionId()
    return a
}
func (a ClientPublishedMessages) WithServerPort (attr interface { ServerPort() server.AttrPort } ) ClientPublishedMessages {
...
func (a ClientPublishedMessagesExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a ClientPublishedMessagesExtra) MessagingDestinationName() AttrDestinationName {return a.AttrDestinationName}
func (a ClientPublishedMessagesExtra) MessagingDestinationTemplate() AttrDestinationTemplate {return a.AttrDestinationTemplate}
func (a ClientPublishedMessagesExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a ClientPublishedMessagesExtra) MessagingDestinationPartitionId() AttrDestinationPartitionId {return a.AttrDestinationPartitionId}
func (a ClientPublishedMessagesExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
