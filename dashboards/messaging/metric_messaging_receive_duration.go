...
type ReceiveDuration struct {
     *prometheus.HistogramVec
     extra ReceiveDurationExtra
}



func NewReceiveDuration() ReceiveDuration {
...
func (m ReceiveDuration) With(operationName AttrOperationName,extras ...interface {ErrorType() error.AttrType;ServerAddress() server.AttrAddress;ServerPort() server.AttrPort;}) prometheus.Observer { 
...
// Deprecated: Use [ReceiveDuration.With] instead
func (m ReceiveDuration) WithLabelValues(lvs ...string) prometheus.Observer {
    return m.HistogramVec.WithLabelValues(lvs...)
}

func (a ReceiveDuration) WithErrorType (attr interface { ErrorType() error.AttrType } ) ReceiveDuration {
    a.extra.AttrErrorType = attr.ErrorType()
    return a
}
func (a ReceiveDuration) WithServerAddress (attr interface { ServerAddress() server.AttrAddress } ) ReceiveDuration {
    a.extra.AttrServerAddress = attr.ServerAddress()
    return a
}
func (a ReceiveDuration) WithServerPort (attr interface { ServerPort() server.AttrPort } ) ReceiveDuration {
    a.extra.AttrServerPort = attr.ServerPort()
    return a
}


type ReceiveDurationExtra struct {
...
func (a ReceiveDurationExtra) ErrorType() error.AttrType {return a.AttrErrorType}
func (a ReceiveDurationExtra) ServerAddress() server.AttrAddress {return a.AttrServerAddress}
func (a ReceiveDurationExtra) ServerPort() server.AttrPort {return a.AttrServerPort}
...
State {
    ...
    auto_escape: None,
    ctx: {
        "AttrExtra": "ReceiveDurationExtra",
        "Instr": "Histogram",
        "InstrMap": {
            "counter": "Counter",
            "gauge": "Gauge",
