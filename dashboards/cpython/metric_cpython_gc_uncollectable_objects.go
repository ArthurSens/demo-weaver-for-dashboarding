...
func (m GcUncollectableObjects) With(gcGeneration AttrGcGeneration,extras ...interface {}) prometheus.Counter {
    return m.CounterVec.WithLabelValues(gcGeneration.Value(),)
}

// Deprecated: Use [GcUncollectableObjects.With] instead
func (m GcUncollectableObjects) WithLabelValues(lvs ...string) prometheus.Counter {
...
State {
    ...
    ctx: {
        ...
        "Name": "gc.uncollectable_objects",
        "Type": "GcUncollectableObjects",
        "attributes": [
            {
