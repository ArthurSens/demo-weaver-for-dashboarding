...
func (AttrDynamodbGlobalSecondaryIndexUpdates) Key() string { return "aws_dynamodb_global_secondary_index_updates" }
...
func (AttrDynamodbGlobalSecondaryIndexes) Key() string { return "aws_dynamodb_global_secondary_indexes" }
...
func (AttrDynamodbProvisionedReadCapacity) Key() string { return "aws_dynamodb_provisioned_read_capacity" }
...
func (AttrDynamodbProvisionedWriteCapacity) Key() string { return "aws_dynamodb_provisioned_write_capacity" }
