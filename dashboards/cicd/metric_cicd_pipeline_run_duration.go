...
func (m PipelineRunDuration) With(pipelineName AttrPipelineName,pipelineRunState AttrPipelineRunState,extras ...interface {CicdPipelineResult() AttrPipelineResult;ErrorType() error.AttrType;}) prometheus.Observer { 
...
func (a PipelineRunDurationExtra) CicdPipelineResult() AttrPipelineResult {return a.AttrPipelineResult}
