...
func NewGcLastCollectionHeapSize() GcLastCollectionHeapSize {
     ...
     return GcLastCollectionHeapSize{ 
        GaugeVec: prometheus.NewGaugeVec(prometheus.GaugeOpts{
            Name: "dotnet_gc_last_collection_heap_size",
            Help: "The managed GC heap size (including fragmentation), as observed during the latest garbage collection.",
     }, labels)}
}

func (m GcLastCollectionHeapSize) With(gcHeapGeneration AttrGcHeapGeneration,extras ...interface {}) prometheus.Gauge {
    return m.GaugeVec.WithLabelValues(gcHeapGeneration.Value(),)
}

// Deprecated: Use [GcLastCollectionHeapSize.With] instead
func (m GcLastCollectionHeapSize) WithLabelValues(lvs ...string) prometheus.Gauge {
...
State {
    ...
    ctx: {
        ...
        "Name": "gc.last_collection.heap.size",
        "Type": "GcLastCollectionHeapSize",
        "attributes": [
            {
